...
if (!source.includes('from "./report-handler.js"')) {
  ...
  else if (!source.includes('from "./v9-admin-ui-v2.js"')) source = source.replace('import { installV9AdminReportApiV2 } from "./v9-admin-report-api-v2.js";', 'import { installV9AdminReportApiV2 } from "./v9-admin-report-api-v2.js";\nimport { installV9AdminUiV2 } from "./v9-admin-ui-v2.js";');
}
