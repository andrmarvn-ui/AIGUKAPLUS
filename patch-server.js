...
for (const version of [
  ...
  "1.7.0-unified-mapping-center","1.7.2-original-dashboard-hard-route"
]) source = source.replaceAll(version, "1.7.4-pre-v21-report-ui-lazy");

fs.writeFileSync(file, source);
console.log("[AIGUKA] Lazy pre-V2.1 report UI routes installed");
