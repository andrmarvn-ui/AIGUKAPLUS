...
if (!source.includes('from "./report-handler.js"')) {
  ...
  if (!source.includes('from "./v9-admin-report-api-v2.js"')) source = source.replace('import { installReportRoutes } from "./report-handler.js";', 'import { installReportRoutes } from "./report-handler.js";\nimport { installV9AdminReportApiV2 } from "./v9-admin-report-api-v2.js";\nimport { installV9AdminUi } from "./v9-admin-ui.js";');
}

source = source.replace(/^import \{ installStableV7Dashboard \} from "\.\/v7-dashboard-stable\.js";\n/m, "");

const routeInstall = `installV9AdminReportApiV2(app);
...
console.log("[AIGUKA] V9 admin/report v2 installed; V8 dashboard retained as fallback");
