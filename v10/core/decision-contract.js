...
export function buildDecisionInstructions() {
  return [
    ...
    "Đọc conversation.messages theo thời gian và request_plan đã được compiler gộp từ lịch sử. request_plan.threads/global_needs là trạng thái nhu cầu chưa hoàn thành; tin mới nhất không được tự xóa trạng thái này.",
    ...
    "Nếu request_plan.threads có state=pending_media, phải chọn đủ catalog tương ứng có grounding.catalog.has_media=true và action=reply_with_slides, needs_slides=true. Chỉ coi media hoàn thành khi hội thoại có bằng chứng ảnh/carousel đã được gửi.",
    ...
    "grounding chứa đúng phần Knowledge đã truy xuất theo nhu cầu; không suy diễn phần đã bị lược bỏ. Chỉ chọn catalog_key thực sự có trong grounding.catalog; catalog cha có thể đại diện toàn bộ thư mục con của nó.",
